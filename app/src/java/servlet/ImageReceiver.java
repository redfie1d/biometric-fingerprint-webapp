...
public class ImageReceiver extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String imgBase64Str = request.getParameter("imgIncoming").replace("@", "+");
            String patientID = request.getParameter("patientID");
            
            Patient p = PatientDAO.getPatientByPatientID(Integer.parseInt(patientID));
            
            System.out.println(patientID);
            System.out.println("receiver: " + p.getVillage() + " " + p.getPatientId());
